...
public class Demo_TestApiInjectionR1 extends BaseRequest<Api_DEMO_ComplexTestEntity> {
     ...
     * @param name 名称
     */
    public Demo_TestApiInjectionR1(String userIds, String name) {
    ...
    public static class DependencyBuilder extends AbstractDependencyBuilder {
        ...
        public Demo_TestApiInjectionR1 build(String userIds, String name) {
            Demo_TestApiInjectionR1 request = new Demo_TestApiInjectionR1(userIds, name);
            request.dependencies = new BaseRequest[dependencies.size()];
            dependencies.toArray(request.dependencies);
            checkDependency(new String[] { "user.userIds" }, request);
            return request;
        }
    }
