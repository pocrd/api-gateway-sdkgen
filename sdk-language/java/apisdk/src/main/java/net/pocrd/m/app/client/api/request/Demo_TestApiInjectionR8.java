...
public class Demo_TestApiInjectionR8 extends BaseRequest<Api_DEMO_ComplexTestEntity> {
     ...
     * @param supplierIds 以半角逗号分隔的供应商id列表
     * @param name 名称
     */
    public Demo_TestApiInjectionR8(String supplierIds, String name) {
    ...
    public static class DependencyBuilder extends AbstractDependencyBuilder {
        ...
        public Demo_TestApiInjectionR8 build(String supplierIds, String name) {
            Demo_TestApiInjectionR8 request = new Demo_TestApiInjectionR8(supplierIds, name);
            request.dependencies = new BaseRequest[dependencies.size()];
            dependencies.toArray(request.dependencies);
            checkDependency(new String[] { "supplier.supplierIds" }, request);
            return request;
        }
    }
