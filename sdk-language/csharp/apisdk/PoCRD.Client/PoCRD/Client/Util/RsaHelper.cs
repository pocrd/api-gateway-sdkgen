...
namespace PoCRD.Client.Util
{
    ...
    {
        private static readonly ILogger logger = LoggerFactory.GetLogger("RsaHelper");
        ...
        public string Sign(string content, string input_charset)
        {
        ...
        public bool Verify(string content, string signedString, string input_charset)
        {
            bool result = false;
            byte[] Data = Encoding.GetEncoding(input_charset).GetBytes(content);
        ...
        /// <param name="input_charset">编码格式</param>
        /// <returns>明文</returns>
        public string EncryptData(string resData, string input_charset)
        {
        ...
        /// <param name="input_charset">编码格式</param>
        /// <returns>明文</returns>
        public string DecryptData(string resData, string input_charset)
        {
            if (privateKey == null) return null;
        ...
        private string Decrypt(byte[] data, string privateKey, string input_charset)
        {
            string result = "";
            RSACryptoServiceProvider rsa = DecodePemPrivateKey(privateKey);
            SHA1 sh = new SHA1CryptoServiceProvider();
