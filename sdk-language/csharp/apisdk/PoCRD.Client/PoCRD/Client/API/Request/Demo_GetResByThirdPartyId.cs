...
ja-jp:多言語テスト
     ...
     *
     */
    public class Demo_GetResByThirdPartyId : BaseRequest<Api_StringResp> 
    {
...
ja-jp:多言語テスト
         */
        public Demo_GetResByThirdPartyId(string r_in) 
                    : base("demo.getResByThirdPartyId", SecurityType.Integrated)
        {
            try 
            {
         ...
         * 私有的默认构造函数，请勿使用
         */
        private Demo_GetResByThirdPartyId() : base("demo.getResByThirdPartyId", SecurityType.Integrated)
        {
        }
