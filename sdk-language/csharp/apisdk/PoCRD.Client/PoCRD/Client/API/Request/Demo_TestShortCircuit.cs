...
ja-jp:多言語テスト
     ...
     *
     */
    public class Demo_TestShortCircuit : BaseRequest<Api_DEMO_DemoEntity> 
    {
...
ja-jp:多言語テスト
        ...
        public Demo_TestShortCircuit(string name) 
                    : base("demo.testShortCircuit", SecurityType.None)
        {
            try 
            {
         ...
         * 私有的默认构造函数，请勿使用
         */
        private Demo_TestShortCircuit() : base("demo.testShortCircuit", SecurityType.None)
        {
        }
