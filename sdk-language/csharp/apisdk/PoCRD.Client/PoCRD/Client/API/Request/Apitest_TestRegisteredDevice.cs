...
namespace PoCRD.Client.API.Request
{
     ...
     *
     */
    public class Apitest_TestRegisteredDevice : BaseRequest<Api_NumberResp> 
    {
        ...
        public Apitest_TestRegisteredDevice(int intParam) 
                    : base("apitest.testRegisteredDevice", SecurityType.RegisteredDevice)
        {
            try 
            {
         ...
         * 私有的默认构造函数，请勿使用
         */
        private Apitest_TestRegisteredDevice() : base("apitest.testRegisteredDevice", SecurityType.RegisteredDevice)
        {
        }
