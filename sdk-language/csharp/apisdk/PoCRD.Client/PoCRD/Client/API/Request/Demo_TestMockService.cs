...
namespace PoCRD.Client.API.Request
{
 ...
 ja-jp:モックサービス・テスト
     ...
     *
     */
    public class Demo_TestMockService : BaseRequest<Api_DEMO_DemoEntity> 
    {
...
ja-jp:多言語テスト
        ...
        public Demo_TestMockService(string name) 
                    : base("demo.testMockService", SecurityType.None)
        {
            try 
            {
         ...
         * 私有的默认构造函数，请勿使用
         */
        private Demo_TestMockService() : base("demo.testMockService", SecurityType.None)
        {
        }
