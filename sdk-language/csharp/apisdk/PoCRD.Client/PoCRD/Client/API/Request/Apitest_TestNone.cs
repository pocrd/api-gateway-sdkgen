...
namespace PoCRD.Client.API.Request
{
     ...
     *
     */
    public class Apitest_TestNone : BaseRequest<Api_NumberResp> 
    {
        ...
        public Apitest_TestNone(int intParam) 
                    : base("apitest.testNone", SecurityType.None)
        {
            try 
            {
         ...
         * 私有的默认构造函数，请勿使用
         */
        private Apitest_TestNone() : base("apitest.testNone", SecurityType.None)
        {
        }
