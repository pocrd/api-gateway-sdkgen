...
namespace PoCRD.Client.API.Request
{
     ...
     *
     */
    public class Apitest_TestAppendServiceLog : BaseRequest<Api_StringResp> 
    {
        ...
        public Apitest_TestAppendServiceLog(string param) 
                    : base("apitest.testAppendServiceLog", SecurityType.None)
        {
            try 
            {
         ...
         * 私有的默认构造函数，请勿使用
         */
        private Apitest_TestAppendServiceLog() : base("apitest.testAppendServiceLog", SecurityType.None)
        {
        }
