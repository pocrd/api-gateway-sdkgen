 ...
 */
@implementation PoCDemo_TestIgnoreParameterForSecurity
...
{
    if (self = [super initWithMethodName:@"demo.testIgnoreParameterForSecurity" securityType:SecurityType_None])
    {
