 ...
 */
@implementation PoCApitest_TestRegisteredDevice
...
{
    if (self = [super initWithMethodName:@"apitest.testRegisteredDevice" securityType:SecurityType_RegisteredDevice])
    {
