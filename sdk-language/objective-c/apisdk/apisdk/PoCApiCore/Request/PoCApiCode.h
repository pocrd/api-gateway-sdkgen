...
typedef enum {
    ...
    /* JAXB转换XML为对象时发生异常 */
    PoCApiCode_LOGISTICS_JAXB_TRANSFER_ERR_2000003 = 2000003,
    ...
    /* 调拨单系统内部异常 */
    PoCApiCode_TRANSFER_ORDER_INNER_EXCEPTION_2250000 = 2250000,
    
    /* 调拨明细冻结失败 */
    PoCApiCode_TRANSFER_ORDER_SKU_FREEZE_FAILURE_ERROR_2250001 = 2250001,
    
    /* 未找到调拨单记录 */
    PoCApiCode_TRANSFER_ORDER_NOT_FOUND_ERROR_2250002 = 2250002,
    
    /* 未找到调拨单明细记录 */
    PoCApiCode_TRANSFER_ORDER_SKU_NOT_FOUND_ERROR_2250003 = 2250003,
    
    /* 下发调拨单确认命令失败 */
    PoCApiCode_TRANSFER_ORDER_CONFIRM_FAIL_CODE_ERROR_2250004 = 2250004,
    
    /* 调拨单取消失败 */
    PoCApiCode_TRANSFER_ORDER_CANCEL_FAIL_CODE_ERROR_2250005 = 2250005,
    
    /* 批次实物库存小于申请调拨数量 */
    PoCApiCode_TRANSFER_ORDER_BATCH_STOCK_NOT_ENOUGH_CODE_ERROR_2250006 = 2250006,
    
    /* 可售库存小于申请调拨数量 */
    PoCApiCode_TRANSFER_ORDER_SALE_STOCK_NOT_ENOUGH_CODE_ERROR_2250007 = 2250007,
    
    /* 调拨单参数不合法 */
    PoCApiCode_TRANSFER_ORDER_PARAMS_ILLEGAL_2250008 = 2250008,
    
    /* 调拨单不存在 */
    PoCApiCode_TRANSFER_ORDER_NOT_EXIST_2250009 = 2250009,
    
    /* 只有待审批状态的调拨单才能审批 */
    PoCApiCode_TRANSFER_ORDER_STATE_NOT_WAIT_AUDIT_2250010 = 2250010,
    
    /* 只有初始化状态的调拨单才能提交审批 */
    PoCApiCode_TRANSFER_ORDER_STATE_NOT_INIT_2250011 = 2250011,
    
    /* 调拨单的调出仓库不存在 */
    PoCApiCode_TRANSFER_WAREHOUSE_NOT_EXIST_2250012 = 2250012,
    
    /* 同步出库单给仓库异常 */
    PoCApiCode_TRANSFER_ORDER_STOCKOUT_ORDER_SYN_ERROR_2250013 = 2250013,
    
    /* 调拨出库单已存在 */
    PoCApiCode_TRANSFER_OUT_ORDER_EXIST_2250014 = 2250014,
    
    /* 调拨入库单已存在 */
    PoCApiCode_TRANSFER_IN_ORDER_EXIST_2250015 = 2250015,
    
    /* 调拨单调用商品系统接口扣减渠道库存失败 */
    PoCApiCode_TRANSFER_ORDER_CALL_GOODS_SYSTEM_REDUCE_CHANNEL_COUNT_ERROR_2250016 = 2250016,
...
en-us: The biz ID of stock out, which is passed back from delivery is wrong */
    ...
    /* 开放平台获取用户号失败 */
    PoCApiCode_GET_SFHT_USER_ERROR_4001901 = 4001901,
    ...
    /* 发表订单满意度失败 */
    PoCApiCode_PUSH_SATISF_ERROR_14027000 = 14027000,
