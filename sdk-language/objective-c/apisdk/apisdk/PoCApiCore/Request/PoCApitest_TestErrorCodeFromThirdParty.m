 ...
 */
@implementation PoCApitest_TestErrorCodeFromThirdParty
...
- (id) init
{
    if (self = [super initWithMethodName:@"apitest.testErrorCodeFromThirdParty" securityType:SecurityType_None])
    {
