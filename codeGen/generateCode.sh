...
rm -rf ../sdk-language/objective-c/app/client/POCAPICore/Request
rm -rf ../sdk-language/objective-c/app/client/POCAPICore/Response
mkdir ../sdk-language/objective-c/app/client/POCAPICore/Request
mkdir ../sdk-language/objective-c/app/client/POCAPICore/Response
...
java -classpath api-util-1.2.2-SNAPSHOT-allinone.jar net.pocrd.core.generator.ApiSdkObjectiveCGenerator url http://115.28.160.84/info.api POC ../sdk-language/objective-c/app/client/POCAPICore
