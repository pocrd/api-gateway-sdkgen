...
java -jar apigen.jar api-jssdk-gen -url http://www.pocrd.net/info.api?raw -o ../sdk-language/javascript/api net.pocrd.m
java -jar apigen.jar api-javasdk-gen -url http://www.pocrd.net/info.api?raw -o ../sdk-language/java/apisdk/src/main/java/net/pocrd/m/app/client net.pocrd.m.app.client
java -jar apigen.jar api-csharp-gen -url http://www.pocrd.net/info.api?raw -o ../sdk-language/csharp/apisdk/PoCRD.Client/PoCRD.Client/Client PoCRD
java -jar apigen.jar api-oc-gen -url http://www.pocrd.net/info.api?raw -o ../sdk-language/objective-c/apisdk/apisdk/PoCAPICore PoC
java -jar apigen.jar api-doc-gen -url http://www.pocrd.net/info.api?raw -o ../sdk-language/htmldoc
